      ...
      <div className="container">
        <header className={styles.header}>
          ...
          <p>
            ...
            currency and reference match Mezgeb’s protected payment intent.
          </p>
              ...
              >
                ...
                {plan.customPricing ? (
                  <a
                    ...
                    href="mailto:info@hisabtech.com?subject=Mezgeb%20Enterprise%20pricing"
                  >
        ...
        <div className={styles.billingNote}>
          ...
          <span>
            Mezgeb creates an idempotent payment intent, redirects through Chapa, verifies the
