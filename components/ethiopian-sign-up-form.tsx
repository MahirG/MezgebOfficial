    ...
    <form ref={formRef} className="authForm ethiopianSignup" onSubmit={submit} noValidate>
      ...
      <fieldset hidden={step !== 2}>
        ...
        <div className="identityNotice">
          ...
          <span>
            Mezgeb stores the ID type and only the final four characters. The complete document
            number is not stored until an approved verification service is connected.
          </span>
        </div>
        <div className="authGrid">
          <label>
