  ...
  return (
    <footer className="siteFooter">
      <div className="container footerGrid">
        ...
        <div><h3>Product</h3><Link href="/app">Open Mezgeb app</Link><Link href="/#features">Features</Link><Link href="/demo">Quick demo</Link><Link href="/security">Security</Link></div>
