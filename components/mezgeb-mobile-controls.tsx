...
const copy: Record<Exclude<Locale, 'en'>, Record<string, string>> = {
  am: {
    ...
    Search: 'ፈልግ',
    'Search everything in Mezgeb': 'በመዝገብ ውስጥ ሁሉንም ፈልግ',
  ...
  om: {
    ...
    Search: 'Barbaadi',
    'Search everything in Mezgeb': 'Mezgeb keessatti waan hunda barbaadi',
  ...
  ti: {
    ...
    Search: 'ድለ',
    'Search everything in Mezgeb': 'ኣብ Mezgeb ኩሉ ድለ',
  ...
  so: {
    ...
    Search: 'Raadi',
    'Search everything in Mezgeb': 'Wax kasta ka raadi Mezgeb',
    'Search transactions, customers, receipts and settings':
  ...
  aa: {
    ...
    Search: 'Gorris',
    'Search everything in Mezgeb': 'Mezgeb addat inkih gorris',
    'Search transactions, customers, receipts and settings':
  ...
  ar: {
    ...
    Search: 'بحث',
    'Search everything in Mezgeb': 'ابحث عن كل شيء في مزغَب',
    'Search transactions, customers, receipts and settings':
