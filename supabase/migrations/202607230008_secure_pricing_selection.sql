...
set trial_days = 0,
    is_featured = false,
    limits = '{"businesses":1,"advanced_reports":false,"priority_support":false,"vat_receipts_per_month":30}'::jsonb
where code = 'free';

update public.mezgeb_plans
set trial_days = 7,
    is_featured = true,
    limits = '{"businesses":10,"advanced_reports":true,"priority_support":true,"vat_receipts_per_month":null}'::jsonb
where code = 'pro';
