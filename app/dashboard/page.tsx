      ...
      <div className="container">
        <header className="dashboardHero">
          <div>
            ...
            <p>
              Your account is authenticated by Supabase. Every Mezgeb business and financial record
              is isolated through database Row Level Security.
            </p>
          </div>
        ...
        <section
          ...
          aria-label="Mezgeb subscription and identity status"
        >
