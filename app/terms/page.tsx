...
export default function Terms() {
  return (
    <LegalPage title="Terms of service" updated="23 July 2026">
      ...
      <p>
        Mezgeb is designed to help organize business records. It is not presented as ERCA-approved,
        government-certified or a substitute for professional tax advice.
      </p>
