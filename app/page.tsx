      ...
      <section className={styles.outcomesSection}>
        <div className="container">
          <header className={styles.sectionIntro}>
            ...
            <p>
              Mezgeb is designed to make good recordkeeping feel like part of running the
        ...
        <div className="container">
          <div className={styles.localPanel}>
            <div className={styles.localCopy}>
              ...
              <p>
                Mezgeb’s product language begins with the way Ethiopian businesses already operate:
                birr, Dube, local payment channels, multilingual teams and practical daily records.
              </p>
      ...
      <section className={styles.securitySection}>
        <div className="container">
          <div className={styles.securityHeader}>
            ...
            <div>
              <p>
                Mezgeb’s account foundation uses confirmed authentication, protected database
        ...
        <div className="container">
          <div className={styles.finalCtaPanel}>
            <div>
              ...
              <p>
                Create a secure Mezgeb account, confirm your email and begin a 14-day Starter trial
                around your real business workflow.
              </p>
