  ...
  return (
    <LegalPage title="Privacy policy" updated="23 July 2026">
      ...
      <p>
        ...
        registration, Mezgeb retains only the final four characters of the identity number. The
        complete document number is used for client-side format validation and is not sent to or
        stored in the Mezgeb database.
      </p>
      ...
      <p>
        ...
        been verified. Accounts remain marked unverified until Mezgeb connects an approved
